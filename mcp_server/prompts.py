...
def register_prompts(mcp: FastMCP) -> None:
    ...
    def hitl_investigation(
        ...
        lines.extend([
            ...
            "- `intelx_search_tool` — search dark web, pastes, and leaks for indicators (no case required)",
            ...
            "4. If gaps remain, propose follow-up actions (`list_followups`)",
            "",
    ...
    def user_security_check(
        ...
        lines = [
            ...
            "- If it returns positive results, this significantly increases the",
