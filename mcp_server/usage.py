...
TOOL_TAXONOMY: dict[str, dict[str, str]] = {
    ...
    "analyse_office":           {"category": "analysis",    "goal": "investigate"},
    "analyse_pdf":               {"category": "analysis",    "goal": "investigate"},
    "analyse_lnk":               {"category": "analysis",    "goal": "investigate"},
    "analyse_onenote":           {"category": "analysis",    "goal": "investigate"},
    "analyse_macho":             {"category": "analysis",    "goal": "investigate"},
    "analyse_disk_image":        {"category": "analysis",    "goal": "investigate"},
    "analyse_msi":               {"category": "analysis",    "goal": "investigate"},
